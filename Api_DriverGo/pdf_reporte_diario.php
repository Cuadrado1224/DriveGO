...
if (!$reservas) {
    echo json_encode(["error" => "No se encontraron registros para la fecha proporcionada."]);
    exit;
}
...
class PDF extends FPDF {
    function Header() {
        ...
        $this->Cell(170, 15, iconv("UTF-8", "ISO-8859-1", "Reporte Diario de Alquiler"), 0, 1, 'L', false); 
        $this->Ln(10);
    }
